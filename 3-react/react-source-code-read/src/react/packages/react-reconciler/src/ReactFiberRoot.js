...
/**
 * 创建最外层 fiber 对象 fiberRoot 和 rootFiber 
...
export function createFiberRoot(
  ...
  // stateNode is any.
  // 创建根节点对应的 rootFiber（即 <div id="root"></div> 对应的 fiber）
  const uninitializedFiber = createHostRootFiber(tag);
  // 让最外层 fiber 对象 fiberRoot.current = rootFiber
  root.current = uninitializedFiber;
  // 让根节点对应的 fiber 对象 rootFiber.stateNode = fiberRoot
  uninitializedFiber.stateNode = root;

  // 为 rootFiber 添加 updateQueue 属性（是个对象）
